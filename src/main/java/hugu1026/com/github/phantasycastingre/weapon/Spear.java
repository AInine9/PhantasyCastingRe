...
public class Spear extends Weapon {
    ...
    public Spear(int original_power, int melting, int original_sharpness, int polishing) {
    ...
    protected int PowerDefendCalc(int original_power, int melting) {
        ...
        if (melting <= 0 || melting >= 1000) {
            ...
            power_defend = (int) (-5.33e-15 + 0.08 * melting + -8e-05 * Math.pow(melting, 2)) + original_power;
        }
    ...
    protected int SharpDurabilityCalc(int original_sharpness, int polishing) {
        ...
        if (polishing <= 0 || polishing >= 2000) {
            ...
            sharp_durability = (int) (-1.78e-14 + 0.1 * polishing - 5e-05 * Math.pow(polishing, 2)) + original_sharpness;
        }
