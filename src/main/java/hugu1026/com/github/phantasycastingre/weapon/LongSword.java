...
public class LongSword extends Weapon {
    ...
    public LongSword(int original_power, int melting, int original_sharpness, int polishing) {
    ...
    protected int PowerDefendCalc(int original_power, int melting) {
        ...
        if (melting <= 0 || melting >= 1500) {
            ...
            power_defend = (int) (0 + 0.0107 * melting + -7.11e-06 * Math.pow(melting, 2)) + original_power;
        }
        ...
        power_defend = (int) (0.889 * power_defend);
